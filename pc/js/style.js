$(function(){
    ...
    $('.slideGroup .parHd ul li:last').css("border","none");
    $('.slideGroup2 .parHd ul li:last').css("border","none");
    ...
    jQuery(".slideGroup2").slide({titCell:".parHd li",mainCell:".parBd"});
})